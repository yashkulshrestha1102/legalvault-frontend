...
const AddCorporateSecretariatModal = ({ open, onClose, onSave, editData }) => {
  ...
  useEffect(() => {
    if (editData) {
      setFormData({
        csName: editData.csName || '',
        csType: editData.csType || '',
        companyName: editData.companyName || '',
        meetingDate: editData.meetingDate ? editData.meetingDate.split('T')[0] : '',
        ...
        department: editData.department || 'Secretariat',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error('Error saving Corporate Secretariat:', error);
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
      <div className="glass w-full max-w-2xl max-h-[90vh] overflow-y-auto p-6 rounded-2xl relative">
        ...
        <h2 className="text-2xl font-bold mb-6">
          {editData ? '✏️ Edit Record' : '➕ Add Record'}
        </h2>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              ...
              <input
                ...
                placeholder="e.g., Board Meeting Minutes, Compliance Report"
              />
            </div>
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                {pdfs.map((url, idx) => (
                  <div key={idx} className="glass-card px-3 py-2 text-sm flex items-center gap-2">
                    ...
                    <span className="truncate max-w-[150px]">CS_{idx + 1}.pdf</span>
                    <button
                      type="button"
...
export default AddCorporateSecretariatModal;