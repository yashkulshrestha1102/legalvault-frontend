...
const AddIncomeTaxModal = ({ open, onClose, onSave, editData }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert('Failed to save Income Tax record');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
      <div className="glass w-full max-w-2xl max-h-[90vh] overflow-y-auto p-6 rounded-2xl relative">
        ...
        <h2 className="text-2xl font-bold mb-6">
          {editData ? '✏️ Edit Income Tax' : '➕ Add Income Tax'}
        </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              <label className="block text-sm text-gray-400 mb-1">Tax Name *</label>
              <input
                type="text"
                name="taxName"
                ...
                placeholder="e.g., Income Tax Return, TDS Filing"
              />
            </div>
            ...
            {/* Assessment Year */}
            <div>
              <label className="block text-sm text-gray-400 mb-1">Assessment Year</label>
              <input
                type="text"
                name="assessmentYear"
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                {pdfs.map((url, idx) => (
                  <div key={idx} className="glass-card px-3 py-2 text-sm flex items-center gap-2">
                    ...
                    <span className="truncate max-w-[150px]">IncomeTax_{idx + 1}.pdf</span>
                    <button
                      type="button"
...
export default AddIncomeTaxModal;