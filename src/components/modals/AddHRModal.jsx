...
const AddHRModal = ({ open, onClose, onSave, editData }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert('Failed to save HR record');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
      <div className="glass w-full max-w-2xl max-h-[90vh] overflow-y-auto p-6 rounded-2xl relative">
        ...
        <h2 className="text-2xl font-bold mb-6">
          {editData ? '✏️ Edit HR Record' : '➕ Add HR Record'}
        </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              <label className="block text-sm text-gray-400 mb-1">HR Name *</label>
              <input
                type="text"
                name="hrName"
                ...
                placeholder="e.g., Employee Policy, Leave Record"
              />
            </div>

            {/* HR Type */}
            <div>
              <label className="block text-sm text-gray-400 mb-1">HR Type *</label>
              <select
                name="hrType"
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                {pdfs.map((url, idx) => (
                  <div key={idx} className="glass-card px-3 py-2 text-sm flex items-center gap-2">
                    ...
                    <span className="truncate max-w-[150px]">HR_{idx + 1}.pdf</span>
                    <button
                      type="button"
