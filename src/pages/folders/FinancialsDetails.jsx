...
const FinancialsDetails = () => {
  ...
  return (
    <div className="glass p-6">
      ...
      <h1 className="text-3xl font-bold mb-6">{record.financeName}</h1>

      <div className="grid md:grid-cols-2 gap-4 mb-6">
        <div className="glass-card p-4">
          <p className="text-gray-400 text-sm">Finance Type</p>
          <h3 className="font-semibold mt-1">{record.financeType || '-'}</h3>
        </div>
        <div className="glass-card p-4">
          <p className="text-gray-400 text-sm">Period</p>
          <h3 className="font-semibold mt-1">{record.period || '-'}</h3>
        </div>
        <div className="glass-card p-4">
          <p className="text-gray-400 text-sm">Amount</p>
          <h3 className="font-semibold mt-1">{formatCurrency(record.amount, record.currency)}</h3>
        </div>
        <div className="glass-card p-4">
          <p className="text-gray-400 text-sm">Currency</p>
          <h3 className="font-semibold mt-1">{record.currency || 'INR'}</h3>
        </div>
        <div className="glass-card p-4">
            ...
            {record.pdfs.map((pdfUrl, index) => (
              <div key={index} className="glass-card p-4 hover:scale-105 transition">
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-sm font-medium text-center truncate w-full">Financial {index + 1}</p>
